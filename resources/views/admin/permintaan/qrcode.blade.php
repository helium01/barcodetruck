        ...
        <div class="main-panel">
            <div class="content-wrapper">
              ...
              <div class="row">
                <div class="container mt-5" align="center">
                    ...
                    <div id="qrcode" class="mx-auto d-block mt-5" ></div>
                    <a href="/admin/permintaan/acc/{{$permintaan->id}}" class="btn btn-primary mt-5" >Acc Permintaan</a>
                </div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    var qrCodeValue = {!!json_encode($permintaan)!!}
